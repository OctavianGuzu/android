...
public class Profile {
    ...
    public static Profile MockGithubProfile;

    static {
        MockGithubProfile = new Profile();
        MockGithubProfile.setName("Octocat");
        MockGithubProfile.setCompany("GitHubService");
        ...
        MockGithubProfile.setCreatedAt("Thu, May 26, 2015");
        MockGithubProfile.setUpdatedAt("Wed, Jun 03, 2016");
        MockGithubProfile.setPublicRepos(23);
        MockGithubProfile.setOwnedPrivateRepos(7);
        MockGithubProfile.setBlog("someblog.net");
    }
}
